...
func (app *application) doSnippetCreate(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Title, 256), "title", "Max characters count is 256")
	form.CheckField(validator.NotBlank(form.Content), "content", "This field cannot be blank")
	form.CheckField(validator.PermittedValue(form.Expires, 1, 7, 365), "expires", "This field should equal 1, 7, 365")
...
func (app *application) showSignup(w http.ResponseWriter, r *http.Request) {
	data := app.newTemplateData(r)
	data.Form = userSignupForm{}
	app.render(w, http.StatusOK, "signup.tmpl", data)
}

func (app *application) doSignup(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "The field must be a valid email address")
	...
	app.sessionManager.Put(r.Context(), "flash", "Account created successfully. You can now login.")
...
func (app *application) doLogin(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be a valid email addresss")
...
func (app *application) doSignout(w http.ResponseWriter, r *http.Request) {
	err := app.sessionManager.RenewToken(r.Context())
	if err != nil {
		app.serverError(w, err)
		return
